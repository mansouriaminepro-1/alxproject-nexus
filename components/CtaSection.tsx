    ...
    <section className="py-12 px-4 sm:px-6 lg:px-8 bg-white">
        <div className="max-w-7xl mx-auto">
            <div className="bg-brand-black rounded-5xl p-12 md:p-24 relative overflow-hidden text-center">
                ...
                <div className="absolute bottom-0 right-0 w-64 h-64 bg-brand-orange rounded-full filter blur-[80px] opacity-30"></div>
                ...
                <div className="relative z-10 max-w-3xl mx-auto">
                    ...
                    <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                        <button className="w-full sm:w-auto bg-brand-blue hover:bg-brand-blueDark text-white px-8 py-4 rounded-full font-bold text-lg transition-all hover:scale-105 flex items-center justify-center gap-2">
                            Get Started Free

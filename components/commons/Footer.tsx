         ...
         <div className="grid lg:grid-cols-2 gap-16 mb-24">
             ...
             <div>
                 ...
                 <div className="flex gap-4">
                    <a href="/poll/create" className="bg-white text-brand-black px-8 py-3 rounded-full text-sm font-bold uppercase tracking-wider hover:bg-brand-yellow transition-colors">
                        Get Started Free
                    </a>
             ...
             <div className="relative hidden lg:block">
                 ...
                 <img 
                    ...
                    alt="Footer Food" 
                    className="relative z-10 rounded-full border-8 border-brand-darkGray shadow-2xl w-80 h-80 object-cover float-right hover:scale-105 transition-transform duration-700"
                 />

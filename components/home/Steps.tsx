            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="grid lg:grid-cols-2 gap-16 items-center">
                    ...
                    <div className="order-1 lg:order-2">
                        ...
                        <h2 className="text-4xl md:text-5xl font-semibold text-brand-black mb-8 leading-tight">
                        ...
                        <p className="text-brand-text/70 mb-6 text-lg leading-relaxed font-normal">

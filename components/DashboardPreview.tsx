  ...
  return (
    <section className="py-24 bg-white relative overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* The "Card" Visual - Mimicking the reference video layout */}
        <div className="relative w-full bg-brand-bg rounded-5xl p-6 md:p-12 overflow-hidden border border-brand-lightGray shadow-soft">
            ...
            <div className="relative bg-white rounded-4xl shadow-card border border-brand-lightGray overflow-hidden max-w-5xl mx-auto">
                ...
                <div className="h-12 border-b border-brand-lightGray flex items-center px-6 gap-2 bg-white sticky top-0 z-10">
                    ...
                    <div className="ml-4 px-3 py-1 bg-brand-bg rounded-md text-xs font-medium text-brand-gray flex-1 text-center">
                ...
                <div className="p-8 grid md:grid-cols-3 gap-8">
                    ...
                    <div className="col-span-1 space-y-6 hidden md:block">
                        <div className="space-y-2">
                            ...
                            <div className="h-8 w-full bg-brand-bg rounded-lg"></div>
                        </div>
                        <div className="space-y-2">
                    ...
                    <div className="col-span-1 md:col-span-2">
                        <div className="flex justify-between items-center mb-6">
                            <h3 className="text-xl font-bold">Summer Menu A/B Test</h3>
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            ...
                            <div className="group relative rounded-2xl overflow-hidden border-2 border-brand-blue shadow-lg transition-transform hover:scale-[1.02]">
                                ...
                                <div className="p-4 bg-white">
                                    <div className="flex justify-between items-end mb-2">
                                        <h4 className="font-bold text-sm">Wagyu Smash</h4>
                            ...
                            <div className="group relative rounded-2xl overflow-hidden border border-brand-lightGray opacity-70 transition-opacity hover:opacity-100">
                                ...
                                <div className="p-4 bg-white">
                                    <div className="flex justify-between items-end mb-2">
                                        <h4 className="font-bold text-sm">Classic Single</h4>
                                        <span className="text-xl font-bold text-brand-gray">38%</span>
                                    </div>
                                    <div className="w-full bg-brand-bg h-2 rounded-full overflow-hidden">
                                        <div className="w-[38%] h-full bg-brand-gray"></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        {/* Insights */}
                        <div className="mt-6 p-4 bg-brand-bg rounded-xl flex items-start gap-3">
                            ...
                            <div>
                                ...
                                <p className="text-xs text-brand-gray mt-1">The Wagyu Smash is performing 3x better with the 18-24 demographic in your area.</p>
                            </div>
                        </div>

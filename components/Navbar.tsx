          ...
          <div className="flex justify-between items-center">
            ...
            <div className="hidden md:flex items-center gap-6">
              <button
                ...
                className="text-base font-bold text-brand-black hover:text-brand-black/70 transition-colors"
              >
                Log in
              </button>
              <button
                onClick={() => openAuth('signup')}
                className="text-base font-bold text-white bg-brand-black rounded-full px-8 py-3 hover:bg-brand-black/90 hover:scale-105 transition-all shadow-lg shadow-brand-black/20"
              >
                Start Battle
              </button>
            </div>

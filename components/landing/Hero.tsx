        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            ...
            <div className="text-left relative z-20">
                ...
                <div className="flex flex-col sm:flex-row items-start sm:items-center gap-6">
                    <a href="/poll/create" className="group bg-brand-black text-white px-8 py-4 rounded-full font-bold text-sm uppercase tracking-wider hover:scale-105 transition-all duration-300 flex items-center gap-3 shadow-xl hover:shadow-2xl hover:bg-gray-900">

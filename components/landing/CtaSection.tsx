            ...
            <div className="bg-brand-black rounded-5xl p-12 md:p-24 relative overflow-hidden text-center">
                ...
                <div className="relative z-10 max-w-3xl mx-auto">
                    ...
                    <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                        <a href="/poll/create" className="w-full sm:w-auto bg-brand-yellow hover:bg-white text-brand-black px-8 py-4 rounded-full font-bold text-lg transition-all hover:scale-105 flex items-center justify-center gap-2">
                            Get Started Free

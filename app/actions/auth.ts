...
export async function signup(formData: FormData) {
    ...
    // ⚠️ SECURITY: This key bypasses RLS. Must ONLY be used on the server.
    // Verified: This file has 'use server' directive at the top.
    ...
    if (serviceRoleKey) {
        ...
        const { error: dbError } = await adminClient
            ...
            .upsert({
                id: authData.user.id,
                restaurant_name: 'My Restaurant', // Default value
                owner_name: userName,
